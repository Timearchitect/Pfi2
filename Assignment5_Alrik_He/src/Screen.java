...
public class Screen extends Canvas implements ClockInterface {
 ...
 private void drawRomanNumbers(){ 
	 int length;
	 float angle;
	//	_g.drawLine(radius, radius, (int)(length*Math.cos(Math.toRadians(angle))+radius),(int)(length*Math.sin(Math.toRadians(angle))+radius));
